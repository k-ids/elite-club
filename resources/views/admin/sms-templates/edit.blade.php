      ...
      <div class="row">
        <div class="col-md-10">
          <div class="card card-primary">
            ...
            {!! Form::open(['route' => ['sms-templates.update', $smsTemplate->id], 'files' => true, 'method'=>'PUT']) !!}
            <div class="card-body">

              <div class="form-group">
                {!! Form::label('title', 'Title', ['class' => 'required']) !!}
                {!! Form::text('title', old('title', $smsTemplate->title), ['class' => 'form-control']) !!}
                  @error('title')
              ...
              <div class="form-group">
                ...
                {!! Form::text('subject', old('subject', $smsTemplate->subject), ['class' => 'form-control']) !!}
                  @error('subject')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
              ...
              <div class="form-group">
                ...
                {!! Form::textarea('template', old('template', $smsTemplate->template), ['class' => 'form-control textarea']) !!}
                 @error('template')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
